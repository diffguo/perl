...
import (
	...
	"jasonghw/xproject/DemoService/httpsrv"
	"net/http"
	_ "net/http/pprof"
)
...
func initConfig() (*ServiceConfig, error) {
	gConfigFile = flag.String("c", "demo.conf", "config file")
	flag.Parse()
...
func main() {
	...
	startHttpServer(*gConfigFile, gConfig.Custom.HttpListenAddr)
